import 'package:bookangy/Pages/About_Screens/ui/Developers/Developer.dart';
import 'package:bookangy/Pages/About_Screens/ui/developerdetails/developer_details_page.dart';
...
class AboutPage extends StatelessWidget {
  final List<Developer> _Developers = [
    Developer(
      avatar: "assets/images/asmaa_photo.jpg",
      name: "Asmaa Nasser",
      email: "asmaa98seif@gmail.com",
      university: "Computer science,Helwan University",
      address: "Sheikh Zayed,Giza",
      age: '21',
      description: [
        'Asmaa Nasser, Level 3',
        'Worked before as',
        '1-Lead & Founder at Google Developers Students Club - Helwan University',
        '2-Former DNA ambassador at IBM Egypt',
        '3-Ambassador at CyberTalents',
        '4-Former Public Relations Head at Minders',
      ],
      about:
      'I am an IT student at Helwan University , I believe that teaching others and learning from them is the most valuable thing.  I am interested in Technology , entrepreneurship and training in addition to anything that gives you the opportunity to show out your creativity and leave a good impact',
      portfolioImagesUrls: [
...
//        'assets/images/salah_4.png',
      ...
      facebookPage: 'https://www.facebook.com/AsmaaNasserS',
      githubPage: 'https://github.com/orgs/SW-2-FCAIH/people/AsmaaNasserS',
      twitterPage: 'https://twitter.com/AsmaaNa51369069',
      whatsAppNumber: '+2001013203362',
      phoneNumber: '+201013203362',
        ...
        child: Padding(
          ...
          child: GridView.count(
            ...
            children: <Widget>[
              ...
              _buildCard(_Developers[3], context),
            ],
          ),
        ),
      ),
